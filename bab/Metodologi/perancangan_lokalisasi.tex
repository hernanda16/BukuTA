...
% Perlu paper yang ngestate lebih dari 3 jam logging
% Perlu paper allan variance
% Perlu paper faktor inflasi untuk safety margin
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        ...
        \caption{Dokumentasi proses kalibrasi kecepatan odometri roda menggunakan \emph{stopwatch}.}
    ...
    \begin{subfigure}[b]{0.8\textwidth}
        \centering
        \includegraphics[width=\textwidth]{gambar/kalibrasi_runtime.png}
    ...
    \end{subfigure}
    \caption{Kalibrasi kecepatan odometri roda menggunakan metode pencatatan waktu tempuh pada titik acuan.}
...
Pada tahap prediksi, akselerasi IMU yang telah dirotasi ke kerangka ENU digunakan untuk memproyeksikan \emph{state} dan kovarians ke langkah waktu berikutnya melalui model sistem kontrol masukkan.
