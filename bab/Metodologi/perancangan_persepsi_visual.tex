...
Model ini dipralatih pada \emph{dataset} Mapillary Vistas yang berskala global sehingga telah memiliki kemampuan dasar dalam mengenali berbagai tipe jalan dan lingkungan perkotaan.
Selanjutnya dilakukan \emph{fine-tuning} pada \emph{dataset} lokal kampus ITS agar model dapat beradaptasi dengan karakteristik visual jalan di lingkungan pengujian.
...
Pelabelan dilakukan secara manual menggunakan perangkat lunak LabelMe dan Roboflow, di mana setiap piksel pada citra diberi \emph{road} (jalan yang dapat dilalui) \emph{background} (non-jalan).
...
\begin{figure}[H]
    ...
    \end{subfigure}
    \caption{Proses pelabelan \emph{dataset} segmentasi visual.}
    \label{fig:pelabelan}
\end{figure}
