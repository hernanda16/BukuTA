...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{gambar/google_my_maps.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{gambar/google_segment.png}
...
Titik \emph{point cloud} yang diterima pada tahap perencanaan rute lokal pertama-tama disaring menggunakan informasi rute GPS.
...
Setiap busur $a$ dievaluasi menggunakan fungsi skor yang terdiri dari dua variabel yaitu kedekatan arah terhadap sudut kemudi referensi dan jarak aman kendaraan terhadap \emph{obstacle} sebagaimana didefinisikan pada Persamaan~\eqref{eq:dwa_score} hingga~\eqref{eq:dwa_clearance}:
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{gambar/dwa_arc.png}
