...
Pertama, \emph{pipeline} persepsi visual yang mencakup pelatihan model InternImage dengan \emph{fine-tuning} pada \emph{dataset} lokal ITS, konversi model ke \emph{engine} TensorRT, dan implementasi modul konversi masker biner ke \emph{point cloud}.
...
Keempat, perencanaan lokal berbasis \emph{corridor pursuit} dengan \emph{dual-mode target heading} yang mengintegrasikan data visual dan GPS.
