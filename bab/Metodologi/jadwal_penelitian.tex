...
Pertama, \emph{pipeline} persepsi visual yang mencakup pelatihan model InternImage dengan \emph{fine-tuning} pada dataset lokal ITS, konversi model ke \emph{engine} TensorRT, dan implementasi modul konversi masker biner ke \emph{point cloud}.
