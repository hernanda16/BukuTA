...
\begin{enumerate}
    ...
    Pada 6 rute dengan panjang berbeda, Kalman Filter secara konsisten memiliki RMSE lebih rendah daripada GPS.
    Pada area Rektorat dengan degradasi GPS, Kalman Filter mempertahankan RMSE 1,07--1,56 m sementara GPS mengalami \emph{drift} hingga 9,43 m.
    ...
    Pada kondisi degradasi GPS alami di area Rektorat, Kalman Filter tidak mengalami masalah signifikan meskipun GPS mengalami \emph{drift}.
