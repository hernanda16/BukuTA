...
Panjang lintasan Kalman Filter (m)         & 3.674,21 \\
Selisih panjang (m)             & 0,19 (0,005\%) \\
RMSE Kalman Filter vs DLIO (m)             & 1,08 \\
...
Selisih panjang lintasan antara Kalman Filter dan DLIO hanya 0,19~m dari total 3.674~m, atau 0,005\%, menunjukkan bahwa sistem mampu melacak posisi secara konsisten tanpa akumulasi galat yang signifikan sepanjang perjalanan. RMSE posisi tercatat 1,08~m dengan deviasi maksimum 1,99~m.
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        ...
        \label{fig:uji2_zoom}
    \end{subfigure}
    \caption{Lintasan Kalman Filter terhadap DLIO pada pengujian \emph{autonomous} jarak jauh 3,7~km.}
    \label{fig:uji2_far}
\end{figure}
...
Pada kondisi pertama, sistem beroperasi tanpa injeksi derau GPS ($\sigma = 0$), sedangkan pada kondisi kedua, sistem beroperasi dengan injeksi derau Gaussian pada data GPS ($\sigma = 0,2$ m) untuk mensimulasikan kondisi degradasi sinyal GPS.
