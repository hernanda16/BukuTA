...
\hline
\endhead
$\hat{x}$ & & Vektor \emph{state} estimasi Kalman Filter \\
$P$ & & Matriks kovarians estimasi Kalman Filter \\
$Q$ & & Matriks kovarians derau proses \\
$R$ & & Matriks kovarians derau pengukuran \\
$K$ & & \emph{Kalman Gain} \\
$A$ & & Matriks transisi sistem \\
$C$ & & Matriks observasi \\
$B$ & & Matriks masukan kontrol \\
$u$ & m/s$^2$ & Vektor masukan akselerasi \\
$z$ & & Vektor pengukuran sensor \\
